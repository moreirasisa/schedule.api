...
class AppointmentRepository:
    ...
    async def create(db, appointment: AppointmentModel):
        ...
        result = await db['appointments'].insert_one(appointment_dictionary)
